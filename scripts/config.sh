...
ENVOY_GATEWAY_LOCAL_HTTPS_PORT="${ENVOY_GATEWAY_LOCAL_HTTPS_PORT:-8443}"

CERT_MANAGER_VERSION="${CERT_MANAGER_VERSION:-v1.18.4}"
CERT_MANAGER_NAMESPACE="${CERT_MANAGER_NAMESPACE:-cert-manager}"

SEALED_SECRETS_VERSION="${SEALED_SECRETS_VERSION:-v0.38.4}"
